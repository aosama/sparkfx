...
import com.its.sparkfx.forms.main.FrmMainView;
...
//        stage.show();
        ...
        FrmMainView frmMainView = new FrmMainView();
        Scene scene = new Scene(frmMainView.getView());
        stage.setTitle("SparkFX");
        stage.setScene(scene);
